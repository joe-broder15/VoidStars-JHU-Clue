...
function JoinGame({ setGlobalId }) {
  ...
  function joinGame() {
    axios
      .post("http://127.0.0.1:5742/api/join_game", {
        username: username,
      })
      .then((response) => {
  ...
  function selectCharacter(e) {
    axios
      .post("http://127.0.0.1:5742/api/set_character", {
    ...
    return (
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>Click below to join the game.</Card.Text>
          <Form>
